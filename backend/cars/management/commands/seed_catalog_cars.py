...
CATALOG_CARS = [
    ...
    car('Audi', 'A6 45 TFSI quattro', 2018, 88000, '29900', 'petrol', 'automatic', 'Sedan', 'Used - Good', 'Silver', True, '105', ['Audi A6, GIMS 2018, Le Grand-Saconnex (1X7A1490).jpg', 'Audi A6 2018 (44686504882).jpg', 'Audi A6 C7 (Type 4G) Wien 25 July 2020 JM.jpg']),
    ...
    car('Tesla', 'Model 3 Long Range', 2021, 42000, '37900', 'electric', 'automatic', 'Sedan', 'Used - Excellent', 'Red', True, '120', ['2019 Tesla Model 3 Long Range Dual Motor in Red Multi-Coat, front left, 2021-05-30.jpg', 'Tesla Model 3 2021 facelift.jpg']),
    car('Tesla', 'Model Y Long Range', 2020, 55000, '44500', 'electric', 'automatic', 'SUV', 'Used - Excellent', 'White', True, '140', ['2020 Tesla Model Y, front 8.1.20.jpg', 'Tesla Model Y 1X7A6211.jpg', 'Tesla Model Y front view 7-19-2020.jpg']),
    ...
    car('Toyota', 'RAV4 Hybrid XA50', 2021, 39000, '36500', 'hybrid', 'automatic', 'SUV', 'Used - Excellent', 'Grey', True, '110', ['2021 Toyota RAV4 PHV.jpg', 'TOYOTA RAV4 (XA50) TAIL LAMP.jpg', 'TOYOTA RAV4 (XA50) TAIL LAMP (2).jpg']),
    ...
    car('Mercedes-Benz', 'E-Class W213', 2020, 57000, '43800', 'diesel', 'automatic', 'Sedan', 'Used - Excellent', 'Black', True, '145', ['MERCEDES-BENZ E-CLASS (W213) China.jpg', 'MERCEDES-BENZ E-CLASS (W213) China (3).jpg', 'MERCEDES-BENZ E-CLASS (W213) China (4).jpg']),
    ...
    car('Hyundai', 'Santa Fe TM', 2021, 47000, '34900', 'diesel', 'automatic', 'SUV', 'Used - Excellent', 'Blue', True, '112', ['Hyundai Santa Fe (TM) IMG001.jpg', '0 Hyundai Santa Fe (CM) 1.jpg', '0 Hyundai Santa Fe (CM) 2.jpg']),
    ...
    car('Porsche', 'Cayenne Coupe GTS', 2019, 59000, '73500', 'petrol', 'automatic', 'SUV', 'Used - Excellent', 'Red', True, '240', ['Porsche Cayenne Coupé GTS 1X7A7224.jpg', 'Porsche Cayenne S Hybrid Concept IMG 0840.jpg', 'Porsche Cayenne Turbo GT Auto Zuerich 2021 IMG 0298.jpg']),
